...
class RENNHarness(KNNHarness):
    ...
    @property
    def curr_theta(self) -> float:
        return self._curr_theta

    @curr_theta.setter
    def curr_theta(self, theta: float) -> None:
        self._curr_theta = theta

    @property
    def curr_agree_func(self) -> str:
        return self._curr_agree_func

    @curr_agree_func.setter
    def curr_agree_func(self, agree_func: str) -> None:
        self._curr_agree_func = agree_func

    @property
    def curr_kind_sel(self) -> str:
        return self._curr_kind_sel

    @curr_kind_sel.setter
    def curr_kind_sel(self, curr_kind_sel: str) -> None:
    ...
    @best_theta.setter
    def best_theta(self, theta: float) -> None:
        self._best_theta = theta

    @property
    def best_agree_func(self) -> str:
        return self._best_agree_func

    @best_agree_func.setter
    def best_agree_func(self, agree_func: str) -> None:
        self._best_agree_func = agree_func

    @property
    def best_kind_sel(self) -> str:
        return self._best_kind_sel

    @best_kind_sel.setter
    def best_kind_sel(self, kind_sel: str) -> None:
        self._best_kind_sel = kind_sel
